...
| Pictogramme | Catégorie | Description |
|:-:|---|---|
| 📜 | **Histoire et fondations** | Origines, papiers fondateurs, timeline |
| 🧠 | **Modèles LLM** | GPT, Claude, Llama, Mistral, Gemini… |
| 🔧 | **Outils et frameworks** | LangChain, RAG, agents, MCP |
| 🆕 | **Nouveautés** | Sorties, benchmarks, annonces |
| 📰 | **Actualités et débats** | Régulation, éthique, marché |
| 🎯 | **Cas d'usage** | Code, content, data, entreprise |
| 📚 | **Ressources** | Tutos, cours, MOOCs, papers |
...
* 🧠 [ChatGPT (novembre 2022)](#chatgpt-novembre-2022)
...
* 🎯 [Cercle vertueux de l'IA, 2024](#cercle-vertueux-de-lia-2024)
...
* **[Claude Code](https://docs.anthropic.com/en/docs/agents-and-tools/claude-code/overview)** (Anthropic) : agent CLI qui opère directement dans le terminal
* **[Cursor](https://cursor.sh/)** : IDE forké de VS Code avec agent intégré
...
* **[Windsurf](https://codeium.com/windsurf)** (Codeium), **[Aider](https://aider.chat/)**, **[OpenHands](https://github.com/All-Hands-AI/OpenHands)**...
...
**[OpenAI](https://openai.com/)** : [GPT-4o](https://openai.com/index/hello-gpt-4o/), [GPT-4.1](https://openai.com/index/gpt-4-1/) (1M tokens contexte), [GPT-5](https://openai.com/index/introducing-gpt-5/)/5.1/5.2 (flagship), série [o1](https://openai.com/index/learning-to-reason-with-llms/)/[o3](https://openai.com/index/introducing-o3-and-o4-mini/)/[o4-mini](https://openai.com/index/introducing-o3-and-o4-mini/) (raisonnement). ChatGPT a dépassé les 200 millions d'utilisateurs.

**[Anthropic](https://www.anthropic.com/)** : Claude 3.5 Sonnet/Haiku, [Claude 4 Opus/Sonnet](https://www.anthropic.com/news/claude-4) (extended thinking, leader SWE-bench), Claude 4.5, Claude 4.6. Approche "[Constitutional AI](https://www.anthropic.com/research/constitutional-ai-harmlessness-from-ai-feedback)" pour la sécurité.

**[Google DeepMind](https://deepmind.google/)** : [Gemini 2.0/2.5/3.0/3.1 Pro](https://deepmind.google/technologies/gemini/), Gemini Flash, Gemini Deep Think. Fenêtres de contexte 1M+ tokens. [Gemma](https://ai.google.dev/gemma) (modèles ouverts). [AlphaEvolve](https://deepmind.google/discover/blog/alphaevolve-a-gemini-powered-coding-agent-for-designing-advanced-algorithms/) (optimisation de code par évolution).

**[Meta AI](https://ai.meta.com/)** : [Llama 3.x](https://llama.meta.com/), [Llama 4](https://ai.meta.com/blog/llama-4-multimodal-intelligence/) (10M tokens contexte, MoE). Open weight mais en perte de vitesse face à Qwen/DeepSeek.

**[Alibaba/Qwen](https://qwenlm.github.io/)** : [Qwen 2.5](https://qwenlm.github.io/blog/qwen2.5/), [Qwen 3](https://qwenlm.github.io/blog/qwen3/), Qwen3-Coder. A dépassé Llama en popularité dans la communauté open weight.
...
**[Mistral AI](https://mistral.ai/)** (France) : Mistral 3 (basé sur architecture DeepSeek V3). Positionnement européen.
...
**[OpenClaw](https://github.com/psteinberger/openclaw)** est un agent AI autonome open-source créé par le développeur autrichien Peter Steinberger, publié initialement en novembre 2025 sous le nom "Clawdbot". Le projet a connu un succès viral avec plus de 247 000 étoiles sur GitHub début mars 2026.
